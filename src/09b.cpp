...
main(i32 NumArgs, char *Args[])
{
    ...
    for(i32 I=0; I<10; ++I)
    {
        Rope[I] = (point){ GridWidth / 2, GridWidth / 2 };
    }

    Grid[ Rope[9].X + Rope[9].Y * GridWidth] = 1;
    ...
    for(i32 I=0; I<LineCount; ++I)
    {
        ...
        for(i32 S=0; S<Steps; ++S)
        {
            ...
            for(i32 T=1; T<10; ++T)
            {
                ...
                Assert(Rope[T].X >= 0 && Rope[T].X < GridWidth && Rope[T].Y >= 0 && Rope[T].Y < GridWidth, "Rope[T].ail out of range");
            }

            i32 Index = Rope[9].X + Rope[9].Y * GridWidth;
            if(Grid[Index] == 0)
            {
                PositionCount++;
                Grid[Index] = 1;
