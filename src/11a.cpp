...
main(i32 NumArgs, char *Args[])
{
    ...
    for(i32 Round=0; Round<20; ++Round)
    {
        for(i32 I=0; I<8; ++I)
        {
            for(i32 J=0; J<Monkeys[I].ItemCount; ++J)
            {
                // Inspect
                i32 Item = Monkeys[I].Items[J];
                ...
                Monkeys[Target].Items[Monkeys[Target].ItemCount++] = Item;
            }

            Monkeys[I].InspectionCount += Monkeys[I].ItemCount;
    ...
    for(i32 I=0; I<8; ++I)
    {
        i32 IC = Monkeys[I].InspectionCount;
        if(IC > Max[1])
        {
            Max[0] = Max[1];
            Max[1] = IC;
